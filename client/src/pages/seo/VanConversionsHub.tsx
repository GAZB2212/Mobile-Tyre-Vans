      ...
      <div>
        ...
        <section className="bg-primary text-white py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <Badge className="bg-accent text-accent-foreground mb-4 text-xs font-semibold">L3H3 &amp; L3H4 Specialist Builds</Badge>
                  ...
                  >
                    <CardContent className="pt-6 pb-5 flex flex-col gap-3">
                      <div className="flex items-start justify-between gap-2">
                        <Truck className="w-8 h-8 text-accent shrink-0 mt-0.5" />
                      ...
                      <span className="text-xs text-accent font-medium flex items-center gap-1 mt-auto">
        ...
        <section className="py-10 border-t border-border">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            <p className="text-muted-foreground text-sm">
              ...
              <Link href="/mobile-tyre-vans" className="text-foreground underline underline-offset-2 hover:text-accent">
